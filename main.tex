...
\input{./PreTexto/entradas-siglas} %alterado por Gerson
%%\include{./PosTexto/entradas-glossario}%% Entradas do glossário - Comente para remover este item
\input{./PosTexto/entradas-glossario} %alterado por Gerson
...
%% Dedicatória (Posteriormente poderá interpor)
%\include{./PreTexto/dedicatoria}%% Comente para remover este item

%% Agradecimentos (Incluir minha querida ESPOSA)
